  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          {isDefaultArea ? (
            <div className="mt-2 flex items-center gap-2">
              ...
              <span className="text-xs text-gray-400">Default area icons cannot be changed.</span>
            </div>
          ) : (
        ...
        <div>
          <label htmlFor="area-target" className="block text-sm font-medium text-gray-700">
            Target hours per week
          </label>
